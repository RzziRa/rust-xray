...
fixture-decode:
	cargo run --bin decode_reality_fixture -- -d tests/fixtures/reality/basic-xray

fixture-decode-write:
	cargo run --bin decode_reality_fixture -- -d tests/fixtures/reality/basic-xray --write-expected --force
